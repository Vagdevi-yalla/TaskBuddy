            ...
            <div className="p-4 space-y-4">
              <div className="border-b border-gray-200">
                <button
                  ...
                  className="flex items-center text-[#7B1984] hover:text-opacity-80 bg-[#F1F1F1] pl-7 pb-3"
                >
              ...
              {showAddTask && (
                <div className="pl-[2.15rem] pt-3">
                  <div className="grid grid-cols-[3fr_1.2fr_1.2fr_1.2fr] gap-4 items-center">
                    <input
                      type="text"
                      placeholder="Task Title"
                      value={newTaskTitle}
                      onChange={(e) => setNewTaskTitle(e.target.value)}
                      className="w-full px-3 py-2 text-sm bg-[#F1F1F1] rounded-lg focus:outline-none placeholder-gray-500"
                    />
                    ...
                    <div className="relative" style={{ zIndex: 140 }}>
                      <button 
                        onClick={() => setShowStatusDropdown(!showStatusDropdown)}
                        className="w-8 h-8 rounded-full flex items-center justify-center bg-[#F1F1F1] hover:bg-gray-200"
                      >
